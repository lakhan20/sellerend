...
if(mysqli_num_rows($res) >0){
    ...
    //    echo $saleOrderRow['Is_canceled'];
        ...
        elseif($saleOrderRow['Is_canceled']==1){
         $str.='
         <th scope="row"><button type="button" class="btn btn-success" disabled>Accept</button></th>
         <th scope="row"><button type="button" class="btn btn-danger" disabled>danger</button></th>  
         ';
        }
